// ._panel_btnshortcut {
    ...
    var th_list_emailtemplatecontent = {
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <p>testขอบคุณที่ทำการนัดหมายกับเราทีมแก้ปัญหาด้านเทคนิค ตัวแทน Google ของเราได้ร้องขอการนัดหมายนี้ในนามของคุณ และเราจะทำการช่วยเหลือคุณในหมายเลขเค <span data-infocase="case_id">0-00000000000000</span> สำหรับ: <span data-infocase="customer_website">customer_website.com</span>.&nbsp;</p>
        ...
        'huong_dan_chen_ma_gtm_va_xac_nhan_lich_hen': `<div id="email-body-content-top-content" dir="auto">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                    <tbody>
                        <tr>
                            <td align="left" height="40"></td>
        ...
        'so_verified': `<div id="email-body-content-top-content" dir="auto">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                    <tbody>
                        <tr>
        ...
        'ni_attempted_contact': `<div id="email-body-content-top-content" dir="auto">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                    <tbody>
                        <tr>
        ...
        'in_not_reachable': `<div id="email-body-content-top-content" dir="auto">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                    <tbody>
                        <tr>
        ...
        'so_verification_not_needed': `<div id="email-body-content-top-content" dir="auto">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                    <tbody>
                        <tr>
        ...
        'ni_awaiting_validation': `<div id="email-body-content-top-content" dir="auto">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                    <tbody>
                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="left" style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
                                                ...
                                                <ol>
                                                    <li dir="ltr" aria-level="1">Đăng nhập vào <a href="https://ads.google.com/intl/th_vn/home/" style="color: rgb(26, 115, 232); text-decoration-line: none;" class="ignore-globals">tài khoản Google Ads</a> của bạn.<br><br></li>
